    ...
    class Customer
    {
        ...
        public Order MakeOrder()
        {
            while (true)
            {
                ...
                {
                    Console.WriteLine("You already have an existing order. Please process and pay for your current order before placing a new one.");
                    Console.WriteLine("Press [Enter] to return to the main menu...");
                    Console.ReadLine();
                    return null; // Return null to indicate that no new order was created
                }
